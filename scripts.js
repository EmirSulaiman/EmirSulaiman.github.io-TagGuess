const tags = ['island', 'malaysia', 'food', 'city', 'laptop', 'house', 'germany', 'russia']
...
function getTaggedPhotos(tagName){
  fetch('https://api.tumblr.com/v2/tagged?tag='  + tagName + '&api_key=suGgXr7s6qn2vewa0rsD9VSRUyRA2Haumf3CP2BYETcLOGCUVC')
